// laba1_2.cpp : Определяет точку входа для приложения.
//
    ...
    case WM_PAINT:
        {
            ...
            HPEN pen1 = CreatePen(PS_SOLID, 1, RGB(123, 255, 9));
            HPEN pen2 = CreatePen(PS_SOLID, 2, RGB(223, 55, 255));
            HPEN pen3 = CreatePen(PS_SOLID, 4, RGB(23, 55, 9));
            ...
            MoveToEx(hdc, 340, 200, NULL);
            LineTo(hdc, 280, 200);
            LineTo(hdc, 300, 300);
            LineTo(hdc, 360, 300);
            LineTo(hdc, 340, 200);
            SelectObject(hdc, pen3);
            MoveToEx(hdc, 360, 150, NULL);
            LineTo(hdc, 300, 150);
            LineTo(hdc, 320, 250);
            LineTo(hdc, 380, 250);
            LineTo(hdc, 360, 150);
